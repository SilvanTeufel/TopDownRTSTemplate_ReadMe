...
If Import is not working, you can add the Action Mapping by yourself:
...
bool CharacterIsUnSelectable = false;		- Set it to true in Constructur Skript to make the Characters unselectable via leftclick on terrain.
